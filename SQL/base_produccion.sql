...
('Sheer Screen blanca', 'Panorama', 120000, 'Sheer', 'https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Sheer_screen_blanca_panorama.jpg'),
('Sheer Screen Blanca', 'Pentagrama', 140000, 'Sheer','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Sheer_screen_blanca_pentagrama.jpg'),
('Screen Alabaster 10%', 'Panorama', 90000, 'Enrrollable','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Screen_Alabaster_Panorama.jpg'),
('BlackOut Blanco', 'Vertiblins', 60000, 'Enrrollable','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Blackout_blanco_Veriblins.jpg'),
('Panel Japones gris', 'Panorama', 120000, 'Panel Japones' ,'https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Panel_Japones_gris_Safra.jpg'),
('Sheer Elegance Tiny gris', 'Panorama', 180000, 'Sheer','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Sheer_Elegance_Tiny_gris_Panorama.jpg'),
('BlackOut Negro', 'Pentagrama', 100000, 'Enrrollable','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Blackout_Negro_Pentagrama.jpg'),
('Screen Blanco', 'Safra', 110000, 'Enrrollable','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Sheer_Screen_blanca_Safra.jpg'),
('BlackOut Blanco', 'Safra', 70000, 'Enrrollable','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Blackout_blanco_Safra.jpg'),
('Panel Japones Screen gris', 'Safra', 130000, 'Panel Japones','https://raw.githubusercontent.com/CarlosSandoval-03/Decorisa_CRUD/develop/src/productos_img/Panel_Japones_Screen_Gris_Safra.jpg')
;
...
-- INDICES
CREATE INDEX ind_nombre_asesor ON asesor (ase_nombreCompleto);
CREATE INDEX ind_nombre_cliente ON cliente (cli_nombreCompleto);
CREATE INDEX ind_pro_functionamiento ON producto (pro_funcionamiento);
CREATE INDEX ind_fecha_cita ON cita (cit_fecha);
...
DELIMITER $$
Create function Valor_ventas_in_range(Venta_1 date, Venta_2 date) returns Int deterministic
BEGIN	
